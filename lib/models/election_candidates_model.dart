...
ElectionCandidatesModel electionCandidatesModelFromJson(String str) =>
    ElectionCandidatesModel.fromJson(json.decode(str));

String electionCandidatesModelToJson(ElectionCandidatesModel data) =>
...
class ElectionCandidatesModel {
  ...
  factory ElectionCandidatesModel.fromJson(Map<String, dynamic> json) =>
      ElectionCandidatesModel(
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        contestants: json["contestants"] == null
            ? []
            : List<Contestant>.from(
                json["contestants"]!.map((x) => Contestant.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "contestants": contestants == null
            ? []
            : List<dynamic>.from(contestants!.map((x) => x.toJson())),
      };
}
